    ...
    <div v-else class="table-data">
      <div class="filter-section">
        <div class="action-area">
          ...
          <el-button type="danger" v-on:click="handleDownloadClick" :icon="Download">
            {{ langStore.t("downloadButton") }}
          </el-button>

          <el-button type="primary" :icon="Plus" v-on:click="addNewItem">
          ...
          <div v-if="uploadedDesignUrl" style="margin-top: 15px">
            <p style="font-weight: bold; margin-bottom: 5px; color: #409eff">
              URL Thiết kế Thi CÔNG mới:
            </p>
            <el-link
              type="primary"
              ...
              :icon="Download"
            >
              Tải xuống Tệp Thiết kế Thi công
            </el-link>
          </div>
        </div>
